...
class StFmsCluster : public StObject {
 public:
  ...
  StLorentzVectorF fourMomentum() const; // Cluster four-momentum (px, py, pz, E)
...
//inline functions
  ...
  inline StLorentzVectorF StFmsCluster::fourMomentum() const { return mFourMomentum; } // Cluster four-momentum (px, py, pz, E)
